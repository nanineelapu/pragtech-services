...
const MainContactContent = () => {
    return (
        <section className="bg-[#faf9f6] py-[15vw] lg:py-[10vw] px-[6vw] lg:px-[4vw] relative overflow-hidden">
            ...
            <div className="max-w-[92vw] mx-auto grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-[10vw] lg:gap-[6vw] relative z-10">
                ...
                <div className="flex flex-col gap-[8vw] lg:gap-[4vw]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-[4vw] lg:gap-[2.5vw]">
                        {/* USA HQ Card */}
                        <div className="group bg-white rounded-[4vw] lg:rounded-[2vw] p-[6vw] lg:p-[3vw] flex flex-col items-start border border-[#153a20]/5 hover:border-[#4dbb6b]/40 transition-all duration-500 shadow-sm hover:shadow-2xl">
                            <div className="flex items-center gap-[4vw] lg:gap-[1.2rem] mb-[4vw] lg:mb-[2vw]">
                                <div className="p-[2.5vw] lg:p-[0.8vw] bg-[#faf9f6] rounded-xl border border-[#153a20]/5">
                        ...
                        <div className="group bg-white rounded-[4vw] lg:rounded-[2vw] p-[6vw] lg:p-[3vw] flex flex-col items-start border border-[#153a20]/5 hover:border-[#4dbb6b]/40 transition-all duration-500 shadow-sm hover:shadow-2xl">
                            ...
                            <div className="mt-[5vw] lg:mt-[2vw] pt-[4vw] lg:pt-[1.5vw] border-t border-[#153a20]/5 w-full">
                                <span className="text-[#153a20] font-black text-[5vw] lg:text-[1.2vw] anton-regular tracking-tight">+91 040-XXXX-XXXX</span>
                            </div>
                        </div>
                ...
                <div className="bg-[#153a20] rounded-[8vw] lg:rounded-[3vw] p-[8vw] lg:p-[4.5vw] shadow-[0_4vw_10vw_-2vw_rgba(21,58,32,0.4)] relative overflow-hidden flex flex-col h-fit">
                    ...
                    <form className="relative z-10 flex flex-col gap-[6vw] lg:gap-[2.5vw]">
                        <div className="grid grid-cols-1 gap-[4vw] lg:gap-[2vw]">
                            <div className="flex flex-col gap-[2vw] lg:gap-[0.8vw]">
                                ...
                                <input className="px-[4vw] lg:px-[1.5vw] py-[3.5vw] lg:py-[1.2vw] bg-white/5 border border-white/10 rounded-[2vw] lg:rounded-[1vw] text-white text-[4vw] lg:text-[1.1vw] outline-none focus:border-[#4dbb6b] focus:bg-white/10 transition-all font-medium" placeholder="E.g. John Doe" />
                            </div>
                            ...
                            <div className="flex flex-col gap-[2vw] lg:gap-[0.8vw]">
                                ...
                                <input className="px-[4vw] lg:px-[1.5vw] py-[3.5vw] lg:py-[1.2vw] bg-white/5 border border-white/10 rounded-[2vw] lg:rounded-[1vw] text-white text-[4vw] lg:text-[1.1vw] outline-none focus:border-[#4dbb6b] focus:bg-white/10 transition-all font-medium" placeholder="operator@domain.com" />
                            </div>
                            ...
                            <div className="flex flex-col gap-[2vw] lg:gap-[0.8vw]">
                                ...
                                <input className="px-[4vw] lg:px-[1.5vw] py-[3.5vw] lg:py-[1.2vw] bg-white/5 border border-white/10 rounded-[2vw] lg:rounded-[1vw] text-white text-[4vw] lg:text-[1.1vw] outline-none focus:border-[#4dbb6b] focus:bg-white/10 transition-all font-medium" placeholder="+1 (XXX) XXX-XXXX" />
                            </div>
                            ...
                            <div className="flex flex-col gap-[2vw] lg:gap-[0.8vw]">
                                ...
                                <textarea className="px-[4vw] lg:px-[1.5vw] py-[3.5vw] lg:py-[1.2vw] bg-white/5 border border-white/10 rounded-[2vw] lg:rounded-[1vw] text-white text-[4vw] lg:text-[1.1vw] outline-none focus:border-[#4dbb6b] focus:bg-white/10 transition-all min-h-[35vw] lg:min-h-[12vw] resize-none font-medium" placeholder="Describe the project scope or inquiry details..." />
                            </div>
                        </div>
