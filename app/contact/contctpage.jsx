...
const ContctPage = () => {
    ...
    return (
        <section
            className="relative w-full min-h-[150vw] lg:min-h-screen flex flex-col items-center lg:justify-center text-center px-[6vw] lg:px-[5vw] overflow-hidden pt-[35vw] lg:pt-[4vw] bg-[#ffffff]"
        >
            {/* Dynamic Background Gradients */}
            <div className="absolute inset-0 pointer-events-none z-0">
                <div className="absolute inset-0 bg-radial-[circle_at_center,rgba(77,187,107,0.08)_0%,transparent_70%]" />
                <div className="absolute inset-0 bg-linear-to-b from-[#0c1f11] via-[#153a20] to-[#0c1f11] opacity-100" />
            </div>
