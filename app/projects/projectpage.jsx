                ...
                <div className="absolute inset-0 opacity-[0.1] pointer-events-none select-none">
                    <svg width="100%" height="100%" viewBox="0 0 100 100" preserveAspectRatio="none">
                        <motion.path 
                            ...
                            stroke="#4dbb6b" strokeWidth="0.1" fill="none" 
                        />
                    </svg>
                </div>
                    ...
                    {projects.map((project, index) => (
                        ...
                        >
                            ...
                            <div className="absolute inset-0 bg-[#153a20] opacity-0 group-hover:opacity-[0.97] transition-all duration-500 z-10 flex flex-col justify-center p-[3vw] lg:p-[2.5vw]">
                                <span className="text-[#4dbb6b] text-[3vw] lg:text-[0.8vw] font-black anton-regular mb-[1vw] lg:mb-[0.8vw]">{project.category}</span>
                                ...
                                <div className="w-fit border-b border-[#4dbb6b] text-[#4dbb6b] anton-regular text-[2.5vw] lg:text-[0.7vw] uppercase tracking-widest pb-[0.2vw]">
                                    Explore →
                                </div>
                            </div>
                            ...
                            <div className="absolute inset-0 flex flex-col justify-end p-[2.5vw] lg:p-[1.8vw] bg-linear-to-t from-black/20 to-transparent">
                                <div className="flex items-center justify-between relative z-0">
                                    <div className="flex flex-col">
                                        <span className="text-[#153a20]/40 text-[2.5vw] lg:text-[0.8vw] anton-regular">{project.id}</span>
                                        <h4 className="text-[3.5vw] lg:text-[1.5vw] text-[#153a20] anton-regular uppercase transition-opacity group-hover:opacity-0 leading-none">
                                            {project.title}
                                        </h4>
                                    </div>
                                    <div className="w-[8vw] lg:w-[2.8vw] h-[8vw] lg:h-[2.8vw] rounded-full border border-[#153a20]/10 flex items-center justify-center text-[#153a20] text-[3vw] lg:text-[1.2vw] group-hover:border-[#4dbb6b] transition-all">
                                        ↗
                                    </div>
                                </div>
                            </div>
