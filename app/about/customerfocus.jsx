...
const CustomerFocus = () => {
    ...
    return (
        <section className="mx-auto flex w-full max-w-[92vw] flex-col items-center py-[15vw] lg:py-[8vw] bg-[#faf9f6] overflow-hidden">
            {/* Main Heading */}
            <motion.div 
                ...
                {focusItems.map((item, index) => (
                    ...
                    >
                        ...
                        <motion.div 
                            ...
                            className="text-[10vw] lg:text-[4vw] font-black text-[#153a20] anton-regular leading-none"
                        >
                            {item.id}
                        </motion.div>
