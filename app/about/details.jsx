    ...
    return (
        <section className="mx-auto flex w-full max-w-[92vw] lg:max-w-[90vw] flex-col items-center gap-8 py-8 pb-24 mt-4 lg:mt-4 lg:gap-12 md:py-12 md:pb-40 overflow-hidden">
            ...
            <motion.div 
                ...
                className="w-full rounded-[6vw] lg:rounded-[3vw] bg-[#faf9f6] p-8 lg:p-14 shadow-[0_2vw_5vw_rgba(21,58,32,0.05)] border border-[#153a20]/5 text-left leading-relaxed"
            >
                <p className="text-[4.5vw] lg:text-[1.3vw] text-[#153a20] font-medium leading-[1.8] lg:leading-loose eb-garamond italic">
            ...
            <div className="flex w-full flex-col gap-6 lg:flex-row lg:gap-10">
                ...
                <motion.div 
                    ...
                    className="flex-1 rounded-[6vw] lg:rounded-[2.5vw] bg-[#153a20] p-8 lg:p-10 shadow-2xl transition-all duration-500 hover:translate-y-[-1vw] border border-white/5 group"
                >
                ...
                <motion.div 
                    ...
                    viewport={{ once: true, margin: "-50px" }}
                    transition={{ duration: 1, ease: "easeOut" }}
                    className="flex-1 rounded-[6vw] lg:rounded-[2.5vw] bg-[#faf9f6] p-8 lg:p-10 shadow-xl border border-[#153a20]/5 transition-all duration-500 hover:translate-y-[-1vw] group"
                >
                    <div className="mb-6 lg:mb-8 flex items-center gap-5 lg:gap-6">
