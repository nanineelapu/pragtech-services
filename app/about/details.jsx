...
const Details = () => {
    return (
        <section className="mx-auto flex w-full max-w-[92vw] lg:max-w-[90vw] flex-col items-center gap-8 py-8 pb-24 mt-4 lg:mt-4 lg:gap-12 md:py-12 md:pb-40">
            {/* Main Text Container - Cream theme */}
            <div className="w-full rounded-[6vw] lg:rounded-[3vw] bg-[#faf9f6] p-8 lg:p-14 shadow-[0_2vw_5vw_rgba(21,58,32,0.05)] border border-[#153a20]/5 text-left leading-relaxed">
                <p className="text-[4.5vw] lg:text-[1.3vw] text-[#153a20] font-medium leading-[1.8] lg:leading-[2] eb-garamond italic">
                    ...
                    <span className="text-[#4dbb6b] font-bold lg:whitespace-nowrap">AISC, CISC, NISD, AWS, OSHA</span>{" "}
                    ...
                    <span className="text-[#4dbb6b] font-bold italic underline decoration-[1vw] lg:decoration-[0.2vw] underline-offset-[1.5vw] lg:underline-offset-[0.4vw]">SDS/2 and Tekla Structures,</span>{" "}
            ...
            <div className="flex w-full flex-col gap-6 lg:flex-row lg:gap-10">
                ...
                <div className="flex-1 rounded-[6vw] lg:rounded-[2.5vw] bg-[#153a20] p-8 lg:p-10 shadow-2xl transition-all duration-500 hover:translate-y-[-1vw] border border-white/5 group">
                    <div className="mb-6 lg:mb-8 flex items-center gap-5 lg:gap-6">
                        <div className="flex h-14 w-14 lg:h-16 lg:w-16 items-center justify-center rounded-2xl bg-white/10 shadow-lg backdrop-blur-md transition-transform group-hover:rotate-12">
                            <svg className="h-7 w-7 lg:h-8 lg:w-8 text-[#4dbb6b]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                <path strokeLinecap="round" strokeLinejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                            </svg>
                        </div>
                        <h3 className="text-[8vw] lg:text-[3vw] font-black tracking-tight text-white anton-regular uppercase">Our Vision</h3>
                    </div>
                    <p className="text-[4.2vw] lg:text-[1.2vw] font-medium leading-[1.7] lg:leading-[1.8] text-white/80 eb-garamond italic">
                ...
                {/* Mission Card - Cream */}
                <div className="flex-1 rounded-[6vw] lg:rounded-[2.5vw] bg-[#faf9f6] p-8 lg:p-10 shadow-xl border border-[#153a20]/5 transition-all duration-500 hover:translate-y-[-1vw] group">
                    <div className="mb-6 lg:mb-8 flex items-center gap-5 lg:gap-6">
                        <div className="flex h-14 w-14 lg:h-16 lg:w-16 items-center justify-center rounded-2xl bg-[#153a20]/5 border border-[#153a20]/10 shadow-sm transition-transform group-hover:rotate-12">
                            <svg className="h-7 w-7 lg:h-8 lg:w-8 text-[#153a20]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" />
                                <circle cx="12" cy="12" r="3" />
                                <circle cx="12" cy="12" r="7" strokeDasharray="4 4" />
                            </svg>
                        </div>
                        <h3 className="text-[8vw] lg:text-[3vw] font-black tracking-tight text-[#153a20] anton-regular uppercase">Our Mission</h3>
                    </div>
                    <p className="text-[4.2vw] lg:text-[1.2vw] font-medium leading-[1.7] lg:leading-[1.8] text-[#153a20]/80 eb-garamond italic">
