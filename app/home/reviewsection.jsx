...
const ReviewSection = () => {
    ...
    const getReviews = () => {
        ...
        if (typeof window !== 'undefined' && window.innerWidth < 1024) {
            // For mobile, just show the active one clearly
            return [{ ...reviews[currentIndex], type: 'active' }];
        }
        return [
    ...
    return (
        <section className="bg-[#faf9f6] rounded-[6vw] lg:rounded-[4vw] mt-[8vw] lg:mt-[5vw] py-[12vw] lg:py-[8vw] px-[6vw] lg:px-[4vw] flex flex-col items-center overflow-hidden w-[92%] mx-auto">
            ...
            <div className="w-full flex flex-row lg:flex-col items-center lg:items-start justify-between lg:justify-start gap-[4vw] lg:gap-0 mb-[10vw] lg:mb-[2vw]">
                ...
                <div className="w-1/2 lg:w-full lg:mt-[2vw]">
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className={`relative rounded-full aspect-square border-2 border-[#153a20]/10 flex flex-col items-center justify-center transition-all duration-700
                                ${isActive ? 'w-[85vw] lg:w-[35vw] bg-white shadow-2xl' : 'w-0 lg:w-[25vw] bg-[#153a20]/2'}
                            `}>
                                {/* Quote Icon */}
                                ...
                                <div className="max-w-[85%] lg:max-w-[75%] flex flex-col items-center">
                                    ...
                                    <div className="flex flex-col items-center">
                                        ...
                                        <h4 className="text-[#153a20] text-[4.5vw] lg:text-[1.4vw] font-black tracking-tight">{review.name}</h4>
                                        <span className="text-[#4dbb6b] text-[2.5vw] lg:text-[0.8vw] font-bold uppercase tracking-widest mt-1 lg:mt-0">{review.company}</span>
                                    </div>
                                </div>
