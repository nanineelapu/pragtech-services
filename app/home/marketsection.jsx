...
const MarketSection = ({ px = "4vw", py = "10vw", width = "92%", ...props }) => {
    ...
    return (
        <section
            className={`bg-white rounded-[6vw] lg:rounded-[4vw] mt-[8vw] lg:mt-[5vw] relative overflow-hidden flex flex-col items-center mx-auto self-center ${props.className || ""}`}
            style={{
        ...
        >
            ...
            {/* View All Button */}
            <div className="mt-[10vw] lg:mt-[6vw] relative z-20">
