...
const MarketSection = ({ px = "4vw", py = "10vw", width = "92%", ...props }) => {
    ...
    return (
        ...
        >
            ...
            >
                <div className="inline-block px-[2vw] py-[0.5vw] bg-teal/10 rounded-full mb-[2vw] lg:mb-[1vw]">
                    <span className="text-navy text-[2.5vw] lg:text-[0.9vw] font-bold tracking-[0.2em] uppercase">Sector Expertise</span>
                </div>
                <h2 className="text-[9vw] lg:text-[4.5vw] font-black text-navy tracking-tight whitespace-nowrap font-heading">
                    MARKETS WE <span className="text-teal">SERVE</span>
                </h2>
                <div className="w-[12vw] lg:w-[6vw] h-[0.8vw] lg:h-[0.3vw] bg-teal mx-auto mt-[2vw] lg:mt-[1vw] rounded-full" />
            </motion.div>
            ...
            <div className="hidden lg:flex w-full justify-center gap-[4vw] relative z-10 min-h-[40vw]">
                ...
                <div className="flex flex-row justify-center gap-[30vw] w-full items-start pt-[2vw]">
                    ...
                    >
                        <div className="relative h-[18vw] rounded-[2vw] overflow-hidden shadow-[0_2vw_5vw_rgba(0,0,0,0.08)] bg-white border border-navy/5 transition-all duration-500 group-hover:-translate-y-2 group-hover:shadow-[0_3vw_6vw_rgba(20,184,166,0.15)]">
                            ...
                            <div className="absolute inset-x-0 bottom-0 p-[2vw] transform translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                                <h3 className="text-[1.5vw] font-black text-white leading-tight font-heading mb-[0.5vw] uppercase">{markets[0].title}</h3>
                                <p className="text-[0.9vw] text-white/70 font-medium leading-relaxed opacity-0 group-hover:opacity-100 transition-opacity duration-500 font-body">{markets[0].desc}</p>
                            </div>
                    ...
                    >
                        <div className="relative h-[18vw] rounded-[2vw] overflow-hidden shadow-[0_2vw_5vw_rgba(0,0,0,0.08)] bg-white border border-navy/5 transition-all duration-500 group-hover:-translate-y-2 group-hover:shadow-[0_3vw_6vw_rgba(20,184,166,0.15)]">
                            ...
                            <div className="absolute inset-0 bg-linear-to-t from-navy via-navy/20 to-transparent" />
                            <div className="absolute inset-x-0 bottom-0 p-[2vw] transform translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                                <h3 className="text-[1.5vw] font-black text-white leading-tight font-heading mb-[0.5vw] uppercase">{markets[2].title}</h3>
                                <p className="text-[0.9vw] text-white/70 font-medium leading-relaxed opacity-0 group-hover:opacity-100 transition-opacity duration-500 font-body">{markets[2].desc}</p>
                            </div>
                            <div className="absolute top-[1.5vw] right-[1.5vw] w-[3.5vw] h-[3.5vw] rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center text-white opacity-0 group-hover:opacity-100 transition-all duration-500">
                                <svg className="w-[1.2vw] h-[1.2vw]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M14 5l7 7m0 0l-7 7m7-7H3" strokeWidth={2.5} /></svg>
                            </div>
                ...
                >
                    <div className="relative h-[18vw] rounded-[2vw] overflow-hidden shadow-[0_2vw_5vw_rgba(0,0,0,0.08)] bg-white border border-navy/5 transition-all duration-500 group-hover:-translate-y-2 group-hover:shadow-[0_3vw_6vw_rgba(20,184,166,0.15)]">
                        ...
                        <div className="absolute inset-0 bg-linear-to-t from-navy via-navy/20 to-transparent" />
                        <div className="absolute inset-x-0 bottom-0 p-[2vw] transform translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                            <h3 className="text-[1.5vw] font-black text-white leading-tight font-heading mb-[0.5vw] uppercase">{markets[1].title}</h3>
                            <p className="text-[0.9vw] text-white/70 font-medium leading-relaxed opacity-0 group-hover:opacity-100 transition-opacity duration-500 font-body">{markets[1].desc}</p>
                        </div>
                        <div className="absolute top-[1.5vw] right-[1.5vw] w-[3.5vw] h-[3.5vw] rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center text-white opacity-0 group-hover:opacity-100 transition-all duration-500">
                            <svg className="w-[1.2vw] h-[1.2vw]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M14 5l7 7m0 0l-7 7m7-7H3" strokeWidth={2.5} /></svg>
                        </div>
            ...
            >
                {markets.map((market, index) => (
                    ...
                    >
                        <div className="relative h-[55vw] rounded-[4vw] overflow-hidden shadow-2xl border border-navy/5">
                            ...
                            <div className="absolute inset-0 flex flex-col justify-end p-[5vw]">
                                <h3 className="text-[5vw] font-black text-white leading-tight mb-[1vw] uppercase tracking-wide font-heading">{market.title}</h3>
                                <p className="text-[3vw] text-white/90 font-medium leading-relaxed font-body">{market.desc}</p>
                            </div>
                            <div className="absolute top-[4vw] left-[4vw] w-[4vw] h-[4vw] border-l-[0.5vw] border-t-[0.5vw] border-teal" />
                        </div>
                    </motion.div>
                ))}
            </motion.div>
            ...
            >
                <button className="flex items-center gap-[2vw] lg:gap-[1vw] px-[8vw] py-[3.5vw] lg:px-[3vw] lg:py-[1.2vw] bg-navy hover:bg-navy/90 text-white font-black rounded-full transition-all shadow-xl active:scale-95 text-[3.5vw] lg:text-[1vw] tracking-wide group font-heading">
                    Explore All Markets
