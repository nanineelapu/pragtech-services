        ...
        <section className="bg-[#153a20] rounded-[6vw] lg:rounded-[4vw] mt-[8vw] lg:mt-[5vw] p-[8vw] lg:p-[6vw] relative overflow-hidden flex flex-col items-start w-[92%] mx-auto">
            ...
            <div className="w-full flex flex-row lg:flex-col items-center lg:items-start gap-[4vw] lg:gap-0 mb-[10vw] lg:mb-[6vw] relative z-10">
                <div className="w-1/2 lg:w-full">
                    <h2 className="text-[7.5vw] lg:text-[4vw] font-black text-white tracking-tighter leading-tight uppercase">
                        Tech <br className="lg:hidden" /> <span className="text-[#4dbb6b]">Stack</span>
                    </h2>
                    <div className="w-[12vw] lg:w-[8vw] h-[0.8vw] lg:h-[0.3vw] bg-[#4dbb6b] mt-[2vw] lg:mt-[1.5vw] rounded-full" />
                </div>

                <div className="w-1/2 lg:w-full lg:mt-[1.5vw]">
                    <p className="text-[2.8vw] lg:text-[1.1vw] text-white/50 font-medium max-w-full lg:max-w-[30vw] italic lg:not-italic text-right lg:text-left">
                ...
                {techLogos.map((tech, index) => (
                    ...
                    >
                        <div className="text-center overflow-hidden w-full">
                            <span
                                className="text-[4.5vw] lg:text-[2.2vw] font-black tracking-tighter opacity-80 group-hover:opacity-100 transition-opacity block truncate px-2"
                        ...
                        <div className="w-0 group-hover:w-[40%] h-[0.5vw] lg:h-[0.2vw] bg-[#4dbb6b] mt-[2vw] lg:mt-[1vw] transition-all duration-300 rounded-full" />
                    </div>
                ))}
            </div>
        </section>
