...
const ServicesPage = ({
    ...
    return (
        <div className="relative w-full min-h-auto lg:min-h-screen flex flex-col items-center bg-transparent select-none transition-colors duration-300">
            ...
            <section className="relative w-full h-[160vw] md:h-[50vw] overflow-hidden group bg-transparent pt-[12vw] md:pt-[4.5vw]">
                ...
                >
                    ...
                    <div className="z-10 flex flex-col items-center gap-[3vw] md:gap-[1vw]">
                        ...
                        >
                            ...
                            <span className="text-teal text-[2.2vw] lg:text-[0.8vw] font-black uppercase tracking-[0.4vw] font-heading">
                        ...
                        >
                            <p className="max-w-[85vw] lg:max-w-[50vw] text-navy/60 text-[3.4vw] md:text-[1.4vw] font-medium tracking-[0.05vw] font-body italic leading-relaxed">
                        ...
                        >
                            <Link href="/projects" className="group relative px-[6vw] md:px-[3vw] py-[2.2vw] md:py-[1.2vw] bg-navy text-white text-[2.2vw] md:text-[0.9vw] font-bold uppercase tracking-[0.2em] rounded-full overflow-hidden transition-all duration-500 hover:shadow-[0_10px_30px_-10px_rgba(15,23,42,0.5)] font-heading cursor-pointer">
                                <span className="relative z-10 transition-colors duration-500 group-hover:text-white font-heading">{primaryLabel}</span>
                            ...
                            <Link href="/contact" className="group px-[6vw] md:px-[3vw] py-[2.2vw] md:py-[1.1vw] border border-navy/20 text-navy text-[2.2vw] md:text-[0.9vw] font-bold uppercase tracking-[0.2em] rounded-full hover:bg-navy hover:text-white transition-all duration-500 font-heading relative overflow-hidden cursor-pointer text-center">
                                <span className="relative z-10 transition-colors duration-500 group-hover:text-white">{secondaryLabel}</span>
