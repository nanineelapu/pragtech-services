        ...
        <div className="relative w-full min-h-auto lg:min-h-screen flex flex-col items-center bg-[#faf9f6] select-none">
            ...
            <section className="relative w-full overflow-hidden bg-linear-to-br from-[#0c1f11] via-[#153a20] to-black py-[22vw] lg:py-[12vw] flex flex-col items-center justify-center text-center px-[6vw] lg:px-[4vw]">
                ...
                <motion.div
                    ...
                    className="relative z-10 flex flex-col items-center w-full max-w-[90vw] lg:max-w-[85vw]"
                >
                    {/* Badge Container */}
                    <motion.div
                        variants={itemVariants}
                        className="px-[4vw] lg:px-[1.5vw] py-[1.5vw] lg:py-[0.5vw] bg-[#4dbb6b]/10 border border-[#4dbb6b]/20 rounded-full mb-[6vw] lg:mb-[3vw] flex items-center gap-[1.5vw] lg:gap-[0.8vw]"
                    >
                    ...
                    <motion.div
                        variants={itemVariants}
                        className="flex flex-col mb-[8vw] lg:mb-[4vw] text-white"
                    >
                    ...
                    <motion.p
                        variants={itemVariants}
                        className="max-w-[85vw] lg:max-w-[50vw] text-[4.2vw] lg:text-[1.5vw] text-white/60 font-medium leading-[1.6] lg:leading-[1.8] mb-[10vw] lg:mb-[5vw] eb-garamond italic uppercase tracking-widest"
                    >
                        {subtitle}
                    </motion.p>
