...
const Cards = () => {
    ...
    return (
        <div className="flex flex-col lg:flex-row gap-[10vw] lg:gap-[6vw] w-full max-w-[92vw] lg:max-w-[82vw] mx-auto min-h-[40vw] text-left px-[4vw] lg:px-0 bg-[#faf9f6]">
            ...
            >
                {services.map((service, index) => (
                    <motion.div
                        ...
                        className={`group relative p-[4vw] lg:p-[1.8vw] rounded-2xl lg:rounded-xl cursor-pointer transition-all duration-300 ${activeIndex === index ? 'bg-[#153a20] translate-x-0 lg:translate-x-1' : 'hover:bg-[#153a20]/5'
                            }`}
                    >
                        ...
                        {activeIndex === index && (
                            <motion.div
                                ...
                                className="absolute bottom-0 left-[4vw] lg:left-[1.8vw] right-[4vw] lg:right-[1.8vw] h-[2px] bg-[#4dbb6b]"
                            />
                        )}
                    </motion.div>
                ))}
            ...
            >
                <div className="lg:sticky lg:top-[12vw] lg:mt-[5vw] bg-[#153a20] rounded-[8vw] lg:rounded-[3vw] p-[8vw] lg:p-[4vw] shadow-2xl overflow-hidden min-h-[30vw] flex flex-col justify-center">
                    ...
                    <AnimatePresence mode="wait">
                        <motion.div
                            ...
                            className="absolute top-[-10vw] right-[-10vw] lg:top-[-5vw] lg:right-[-5vw] text-[35vw] lg:text-[20vw] font-black text-white anton-regular pointer-events-none select-none"
                        >
