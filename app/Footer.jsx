...
const Footer = () => {
    return (
        <footer className="w-full relative px-[4vw] lg:px-0">
            ...
            <div className="bg-[#153a20] overflow-hidden relative transition-all duration-500 rounded-t-[8vw] lg:rounded-none">
                <div className="relative z-10 p-[8vw] lg:p-[5vw]">
                    <div className="flex flex-col lg:grid lg:grid-cols-12 gap-[10vw] lg:gap-[4vw] items-start">
                        ...
                        <div className="order-first lg:order-last lg:col-span-5 flex flex-col gap-[5vw] lg:gap-[2vw] items-start lg:items-end text-left lg:text-right w-full">
                            <div className="flex flex-col gap-[1.5vw] lg:gap-[0.5vw] items-start lg:items-end">
                                <h2 className="text-[12vw] lg:text-[2.5vw] font-black text-white leading-none tracking-tighter uppercase">
                                    Pragtech
                                </h2>
                                <span className="text-[3vw] lg:text-[0.7vw] tracking-[0.6vw] lg:tracking-[0.4vw] text-[#4dbb6b] font-bold uppercase">
                                    Engineering Excellence
                                </span>
                            </div>
                            <p className="text-[4vw] lg:text-[1.1vw] text-white/50 font-medium leading-relaxed max-w-full lg:max-w-[30vw]">
                            ...
                            <div className="flex gap-[4vw] lg:gap-[1vw] mt-[2vw] lg:mt-[1vw]">
                                {['ln', 'tw', 'fb'].map((social) => (
                                    <button key={social} className="w-[12vw] h-[12vw] lg:w-[3.5vw] lg:h-[3.5vw] rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/60 hover:bg-[#4dbb6b] hover:text-white hover:border-[#4dbb6b] transition-all group">
                                        {social === 'ln' && (
                            ...
                            {[
                                ...
                                <div key={section.title} className="flex flex-col gap-[3vw] lg:gap-[0.8vw] group">
                                    <div className="flex items-center gap-[4vw] lg:gap-[1.5vw]">
                                        <h3 className="text-[3.5vw] lg:text-[1vw] font-black text-white/40 tracking-[0.4vw] lg:tracking-[0.3vw] uppercase italic shrink-0">
                                            {section.title}
                                        </h3>
                                        {/* Tech Arrow Symbol */}
                                        <div className="flex-1 h-px bg-white/10 relative overflow-hidden">
                                            <div className="absolute inset-0 bg-linear-to-r from-[#4dbb6b] to-transparent w-full -translate-x-full lg:group-hover:translate-x-0 transition-transform duration-700" />
                                        </div>
                                        <svg className="w-[4vw] lg:w-[1.2vw] h-[4vw] lg:h-[1.2vw] text-[#4dbb6b] transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="3">
                                    ...
                                    <ul className="flex flex-wrap items-center gap-x-[6vw] lg:gap-x-[2.5vw] gap-y-[3vw] lg:gap-y-[1vw] pl-[0.5vw]">
                                        {section.links.map((link) => (
                                            <li key={link}>
                                                <Link href="#" className="text-[4.2vw] lg:text-[1.2vw] font-bold text-white hover:text-[#4dbb6b] transition-all relative group/link">
                                                    {link}
                                                    <span className="absolute -bottom-[0.5vw] lg:-bottom-[0.2vw] left-0 w-0 h-[2px] lg:h-[2px] bg-[#4dbb6b] transition-all duration-300 group-hover/link:w-full" />
                                                </Link>
                                            </li>
                                        ))}
                                    </ul>
                    ...
                    <div className="mt-[12vw] lg:mt-[6vw] pt-[6vw] lg:pt-[2.5vw] border-t border-white/5 flex flex-col lg:flex-row items-center justify-between gap-[6vw] lg:gap-[2vw]">
                        <p className="text-[3.5vw] lg:text-[1vw] text-white/30 font-medium text-center lg:text-left">
                        ...
                        <div className="flex flex-col lg:flex-row items-center gap-[8vw] lg:gap-[4vw]">
                            ...
                            <button
                                ...
                                className="w-[15vw] h-[15vw] lg:w-[4vw] lg:h-[4vw] bg-white/10 rounded-full flex items-center justify-center text-white/60 hover:bg-white hover:text-[#153a20] transition-all group shadow-xl"
                            >
